  ...
  <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">
    ...
    <style>
        ...
        body {
            ...
            background: rgb(89,68,113);
            background: linear-gradient(0deg, rgba(89,68,113,1) 0%, rgba(72,85,171,1) 54%, rgba(41,65,126,1) 100%);
          ...
          <div class="menu">
            <ul>
              ...
              <li>
                ...
                <a href="accounts.php" onclick="showContent('home')">Accounts</a>
              </li>
              <li>
                <i class="fas fa-money-check-alt"></i>
                <a href="sub.php" onclick="showContent('home')">Subscription Data</a>
              </li>
              <li>
                <i class="fas fa-chart-bar"></i>
                <a href="statices.php" onclick="showContent('home')">Statistics</a>
              </li>
              <li>
