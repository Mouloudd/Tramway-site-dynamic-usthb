...
if (!is_dir($uploadDirectory)) {
    mkdir($uploadDirectory, 0777, true); // Create the directory with full permissions (0777)
}
...
<img src="<?php echo isset($image) && file_exists($image) ? $image : 'default_image.jpg'; ?>" alt="Profile Image" width="200" height="200">
